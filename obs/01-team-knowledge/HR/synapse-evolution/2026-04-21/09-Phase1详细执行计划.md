...
- 步骤：定义input_contract和output_contract标准格式
- 验收标准：交接协议草案完成
- 预计工时：2小时
...
| 文件 | 路径 |
|------|------|
| 完整进化方案 | synapse-evolution/2026-04-21/08-进化方案主报告.md |
| 调研报告汇总 | synapse-evolution/2026-04-21/02-07-调研报告-*.md |
| 工作流记录 | synapse-evolution/2026-04-21/01-完整工作流记录.md |
